...
namespace HastaneRandevuOtomasyonProjesi
{
    public partial class FrmBrans : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("delete From Tbl_Branslar where id=@b1", bgl.baglanti());
        ...
        {
            SqlCommand komut = new SqlCommand("update tbl_branslar set BransAd=@p1 where id=@p2", bgl.baglanti());
